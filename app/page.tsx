...
export default function Home() {
  ...
  <a 
    ...
    className="hover:scale-110 transition-transform"
  >
    <Image src="/meesho.png" alt="Meesho" width={60} height={20} className="object-contain" />
  </a>
</div>
              </motion.div>
            </div>
            ...
            <div className="flex flex-col md:flex-row-reverse items-center gap-12 lg:gap-20">
              ...
              <motion.div initial={{ opacity: 0, x: -50 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, margin: "-100px" }} transition={{ duration: 0.8, delay: 0.2 }} className="w-full md:w-1/2 flex flex-col items-start">
                ...
                <div className="flex flex-wrap items-center gap-5 mt-2">
                  ...
                  <a href="https://www.meesho.com/search?q=bamorolife&searchType=manual&searchIdentifier=text_search"  target="_blank" className="hover:scale-110 transition-transform"><Image src="/meesho.png" alt="Meesho" width={60} height={20} className="object-contain" /></a>
                </div>
              </motion.div>
            </div>
