...
export default function Home() {
  ...
  // This ref acts as a sensor to know when the user scrolls to this section
  ...
  // Repeated Marquee Items to ensure no empty spaces
  const marqueeItems = [
  ...
  const fullTestimonials = [...testimonials, ...testimonials]; // Duplicate for infinite scroll
    ...
    <main className="min-h-screen">
      ...
      <section className="relative h-screen flex flex-col items-center justify-center overflow-hidden px-4 bg-forest">
        <div className="absolute inset-0 z-0">
          {/* Ensure your video file is named exactly like this in the public folder */}
          <video autoPlay loop muted playsInline className="absolute inset-0 w-full h-full object-cover" src="/your-video.mp4"></video>
          
          {/* FIX: Increased background opacity to 70% and blur to 4px for better text contrast */}
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto mt-20">
          <motion.h1 
            ...
            // FIX: Added a white text-shadow/glow so it pops off the green background
      ...
      {/* Impact Stats Section (Triggered on Scroll) */}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              ...
              <div 
                key={i} 
                className="bg-cream p-8 rounded-2xl text-center border border-earth/10 shadow-sm transition-all duration-300 hover:-translate-y-2 hover:scale-105 hover:shadow-xl cursor-default"
              >
      ...
      {/* Immersive Products Section (Alternating Layout) */}
      <section className="py-24 bg-cream overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-24 md:space-y-32">
            ...
            {/* Product 1: Kitchen Towels (Image Left, Text Right) */}
            <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-20">
              ...
              >
                {/* Note: Change /towel-lifestyle.jpg to the exact name of your kitchen towel image */}
              ...
              >
                ...
                <p className="text-forest/80 leading-relaxed mb-8 text-lg">
                  Eco-friendly, reusable, and responsibly made for a cleaner home. Wash and reuse a single sheet up to 100 times. Perfect for everyday wiping, drying, and cleaning.
                </p>
                ...
                <a href="#" className="bg-forest text-cream hover:bg-bamboo transition-colors px-10 py-4 rounded-full font-bold uppercase tracking-widest shadow-lg">Buy Now</a>
              </motion.div>
            </div>

            {/* Product 2: Bamboo Napkins (Image Right, Text Left) */}
            <div className="flex flex-col md:flex-row-reverse items-center gap-12 lg:gap-20">
              <motion.div 
                ...
                className="w-full md:w-1/2"
              >
                {/* Note: Use your newly uploaded fries image here! */}
                <div className="relative aspect-[4/5] rounded-3xl overflow-hidden shadow-2xl">
              ...
              >
                ...
                <p className="text-forest/80 leading-relaxed mb-8 text-lg">
                  The future feels softer. Our 100% bamboo napkins naturally absorb excess oil and moisture, making them the perfect companion for your favorite meals. Guilt-free dining starts here.
                </p>
                <ul className="space-y-3 mb-10 text-forest font-medium">
            ...
            {/* Product 3: Bamboo Tissues (Image Left, Text Right) */}
            <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-20">
              <motion.div 
                initial={{ opacity: 0, x: -50 }}
                whileInView={{ opacity: 1, x: 0 }}
              ...
              >
                ...
                <p className="text-forest/80 leading-relaxed mb-8 text-lg">
                  Why settle for scratchy or unsustainable? Bamoro Life brings you the best of both worlds. Gentle enough for the most sensitive skin, and entirely biodegradable.
                </p>
                <ul className="space-y-3 mb-10 text-forest font-medium">
      ...
      <section className="py-12 bg-cream border-t border-forest/10">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center items-center gap-12 md:gap-24 opacity-70 grayscale hover:grayscale-0 transition-all duration-500">
            {/* NOTE: Add your logo images (amazon.png, flipkart.png, meesho.png) to the public folder */}
            <a href="#" target="_blank" className="hover:scale-110 transition-transform"><Image src="/amazon.png" alt="Amazon" width={120} height={40} className="object-contain" /></a>
          </div>
        </div>
      </section>
      ...
      <a 
        ...
        className="fixed bottom-8 right-8 z-[100] bg-[#25D366] text-white p-4 rounded-full shadow-2xl hover:scale-110 transition-transform duration-300 flex items-center justify-center"
      >
